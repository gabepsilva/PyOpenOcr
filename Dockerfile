...
RUN curl -o '/opt/pyopenocr/PyPoenOcr.py' 'https://raw.githubusercontent.com/gabrielpsilva/pyopenocr/master/PyOpenOcr.py'
...
RUN pip3 install flask flask_restful pyopenssl

CMD ["python36", "/opt/pyopenocr/PyPoenOcr.py"]
